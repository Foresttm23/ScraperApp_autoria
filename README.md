...
### Since the app is supposed to be automatic, and scrape all the data from the website, it uses retries and backoff strategies from the `tenacity` library to avoid getting blocked by the website.
